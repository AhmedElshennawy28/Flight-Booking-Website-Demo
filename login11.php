  ...
  <body>
    ...
    <nav class="header">
      <div class="logo">
        ...
        <a href="home.html"> Shennawy's Airport </a>
      </div>
      ...
      if (isset($_POST['login'])) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($decrypt) {
                ...
                echo "<a href='login11.php'><button class='btn'>Go Back</button></a>";
            }
        } else {
            ...
            <form method="post" action="#">
              ...
              <div class="form-group ttt1">
                <p>
                  ...
                  <a href="sign_up.html" class="lin-12">Sign Up</a>
                </p>
              </div>
              <div class="form-group ttt1">
                <p>
                  Forget password ?
                  <a href="newpass.html" class="lin-12">Reset Password</a>
                </p>
              </div>
            </form>
          </div>
