...
if (isset($_POST["sendmsg"])) {
    ...
    elseif (empty($msg)) {
        ...
        try {
            ...
            $body = "<strong>Thank you for reaching out to us!</strong><br><br>We want to let you know our team is doing their best to stay on top of all requests. We will get back to you as soon as possible.<br><br>Keep an eye out for any emails from us within the next 2 days.<br><br>Sincerely,<br>Shennawy Airport Team.";
